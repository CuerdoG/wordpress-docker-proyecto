...
<div class="coming-soon-container">
    <div class="coming-soon-content">
        ...
        <h1 class="coming-soon-title"
            style="color: <?php echo esc_attr( $template_post_data['sruc_heading_color'] ?? '#000000' ); ?>;
        ...
        <div id="countdown"
            ...
            <div id="days" class="time-box">
                <span id="days-num">00</span><br>
                <span>Days</span>
            </div>
            <div id="hours" class="time-box">
                <span id="hours-num">00</span><br>
                <span>Hours</span>
            </div>
            <div id="minutes" class="time-box">
                <span id="minutes-num">00</span><br>
                <span>Minutes</span>
            </div>
            <div id="seconds" class="time-box">
                <span id="seconds-num">00</span><br>
                <span>Seconds</span>
            </div>
        </div>

        <!-- Short Description -->
        <p class="coming-soon-stay-tuned"
           style="
