...
Contributors: themescart
Tags: coming soon, coming soon page, maintenance mode, under construction, under construction mode 
...
Choose from pre-made templates or design your own layout. Add your logo, custom background, text, and buttons effortlessly.

* **🕒 Countdown Timer**
Add a dynamic countdown to build anticipation for your website launch or upcoming event.

* **✉️ Email Signup Integration**
Collect leads before launch! Connect your form to Mailchimp, ConvertKit, or any major email marketing tool.

* **👀 Live Preview**
See your changes instantly as you design your page — no need to save or refresh.

* **👤 Whitelist Access**
Allow admins or specific users to view the live site while visitors see the coming soon page.

* **🔗 Social Media Links**
Add your social profiles to keep visitors connected while you’re offline.

* **📊 Analytics-Ready**
Integrate your Google Analytics ID to track page visits and engagement.
...
= 1.0.2 - 10-12-2025 =
* Theme Templates menu added.

= 1.0.1 - 21-11-2025 =
* Nonce and validating checked and some issue fixed.
