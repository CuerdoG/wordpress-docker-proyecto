 ...
 */
return array(
	'title'      => esc_html__( 'Post Two Column', 'residential-real-estate' ),
	'categories' => array( 'residential-real-estate', 'Post Two Column' ),
...
<!-- wp:post-title {"isLink":true,"style":{"typography":{"fontSize":"22px"},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary","fontFamily":"residential-real-estate-inter"} /-->

<!-- wp:post-excerpt {"excerptLength":20,"style":{"elements":{"link":{"color":{"text":"#747474"}}},"color":{"text":"#747474"},"typography":{"fontSize":"16px"}},"fontFamily":"residential-real-estate-inter"} /-->
