 ...
 */
return array(
	'title'      => esc_html__( 'Latest Blogs', 'residential-real-estate' ),
	'categories' => array( 'residential-real-estate', 'Latest Blogs' ),
	'content'    => '<!-- wp:group {"style":{"color":{"background":"#f4f4f4"},"spacing":{"margin":{"top":"0","bottom":"0"}}}} -->
<div class="wp-block-group has-background" style="background-color:#f4f4f4;margin-top:0;margin-bottom:0"><!-- wp:spacer {"height":"50px"} -->
...
<div class="wp-block-group post-main-area wow fadeInUp has-border-color has-foreground-background-color has-background" style="border-color:#e7e7e7;border-width:1px;border-radius:10px;padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px"><!-- wp:post-title {"isLink":true,"style":{"typography":{"fontSize":"22px"},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary","fontFamily":"residential-real-estate-playfair-display"} /-->

<!-- wp:post-excerpt {"excerptLength":20,"style":{"elements":{"link":{"color":{"text":"#747474"}}},"color":{"text":"#747474"},"typography":{"fontSize":"16px"}},"fontFamily":"residential-real-estate-poppins"} /-->

<!-- wp:post-date {"style":{"elements":{"link":{"color":{"text":"var(--wp--preset--color--extra-primary)"}}},"color":{"text":"var(--wp--preset--color--extra-primary)"}},"fontFamily":"residential-real-estate-poppins"} /--></div>
<!-- /wp:group -->
